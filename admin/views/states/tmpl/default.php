...
?>
<form action="<?php echo JRoute::_('index.php?option=com_toes&view=states'); ?>" method="post" name="adminForm" id="adminForm">
		    ...
		    <table class="table table-striped adminlist">
				<thead>
					<tr>
						...
						<th style="text-align: center" width="1%" class="nowrap">
							<?php echo JHtml::_('grid.sort', 'JGRID_HEADING_ID', 'state.id', $listDirn, $listOrder); ?>
						</th>
					</tr>
				</thead>
				<tfoot>
				...
				<tbody>
					<?php foreach ($this->items as $i => $item) :
						...
						$canChange	= $user->authorise('core.edit.state',	$extension.'.state.'.$item->id);
					?>
