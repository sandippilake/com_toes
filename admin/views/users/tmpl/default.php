		    ...
		    <table class="table table-striped adminlist">
				<thead>
					<tr>
						...
						<th>
							<?php echo JHtml::_('grid.sort', 'User name', 'user.username', $listDirn, $listOrder); ?>
						</th>
						<th>
							<?php echo JHtml::_('grid.sort', 'User group', 'ug.title', $listDirn, $listOrder); ?>
						</th>
						
						<th>
							<?php echo JHtml::_('grid.sort', 'Roll', 'roll', $listDirn, $listOrder); ?>
						</th>
						
						<th width="1%" class="nowrap">
							<?php echo JHtml::_('grid.sort', 'JGRID_HEADING_ID', 'user.id', $listDirn, $listOrder); ?>
						</th>
					</tr>
				</thead>
				<tfoot>
				...
				<tbody>
					...
					<tr class="row<?php echo $i % 2; ?>">
						...
						<td>
							<?php echo $this->escape($item->roll);?></a>
						</td>
