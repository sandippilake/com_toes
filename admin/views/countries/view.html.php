 ...
 * @since		1.6
 */
class ToesViewCountries extends JViewLegacy
{
	//protected $items;
	...
	public function display($tpl = null)
	{
		...
		if($layout == 'edit')
		{
			...
			JToolBarHelper::title($isNew ? JText::_('COM_TOES_COUNTRY_ADD'): JText::_('COM_TOES_COUNTRY_EDIT'), $isNew?'category-add':'category-edit');
			JToolBarHelper::save('countries.save');
			JToolBarHelper::cancel('countries.cancel', 'JTOOLBAR_CLOSE');
		...
		{	
			...
			TOESHelper::addSubmenu('countries');

			$this->sidebar = JHtmlSidebar::render();

			JToolBarHelper::title(JText::_('COM_TOES_COUNTRIES'), 'blue-transparant');
