...
<div id="toes">
	<form id="adminForm" name="adminForm" action="<?php echo JRoute::_('index.php?option=com_toes&view=users'); ?>" method="post" class="form-validate" enctype="multipart/form-data" onsubmit="submitform(this.form);"> 
	    ...
	    <div class="block-rg_number seconouter">
       		<br/><br/>
	        <div class="fieldbg" >
	            <div class="form-label" ><label title="" class="hasTip required" for="official" id="official-lbl"><?php echo JText::_('COM_TOES_OFFICIAL_SELECT_CLUB'); ?><span class="star">&nbsp;*</span></label></div>
                ...
                <?php 
					...
					echo JHTML::_('select.genericlist', $user_rolllist, 'official', '', 'value', 'text', $this->club_detail->club_id);
	            ?>
	            </div>
	            <div class="clr"></div>
	        </div>
	        ...
	        <div class="fieldbg" >
	            ...
	            <div class="form-input" >
	                <input type="text" size="30" class="required" value="<?php echo $this->club_detail->firstname.' '.$this->club_detail->lastname.'-'.$this->club_detail->username;?>" id="official_users" name="official_users" aria-required="true" required="required" >
	            </div>
	            <div class="clr"></div>
	        </div>
	        ...
	        <div class="fieldbg" >
                ...
                <?php 
					...
					echo JHTML::_('select.genericlist', $user_rolllist, 'official_roll', '', 'value', 'text', $this->club_detail->roll_id);
				?>
	            </div>
	            <div class="clr"></div>
	        </div>
	    ...
	    <input type="hidden" name="official_user" id="official_user" value="<?php echo $this->club_detail->user_id;?>" />
	    <input type="hidden" name="previous_user" id="previous_user" value="<?php echo $this->club_detail->user_id;?>" />
	    <input type="hidden" name="previous_roll" id="previous_roll" value="<?php echo $this->club_detail->roll_id;?>" />
	    <input type="hidden" name="previous_club" id="previous_club" value="<?php echo $this->club_detail->club_id;?>" />
