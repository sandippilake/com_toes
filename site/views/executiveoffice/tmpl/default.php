...
<div id="toes">
	<div class ="show-details-main">
		...
		<div class ="seconouter">
			<form action="<?php echo JRoute::_('index.php?option=com_toes&view=executiveoffice&id=' . $data->show_id); ?>" method="post" name="adminForm" id="adminForm">
    ...
    jQuery(document).ready(function(){
		...
		{ 
	        jQuery('.approve-entry').on('click',function(){
				...
				var rel = jQuery(this).attr('rel');
				var ids = rel.split(';');
				if(jQuery('span#docs_'+ids[0]+'_'+ids[1]).length){				
