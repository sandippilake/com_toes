...
$writers = array('Word2007' => 'docx');
		...
		function write($phpWord, $writers,$show_id)
		{
			...
			//	$result .= date('H:i:s') . " Write to {$writer} format";
				if (!is_null($extension)) {
					...
					$xmlWriter->save(JPATH_BASE. "/media/com_toes/DOCX/".$show_id."/master_exibitor_woa_list.docx");
       ...
       $cell->addText(JText::_('COM_TOES_MASTER_EXHIBITOR_WOA_LIST'), $fontStyleTitle, array_merge($paragraphStyleTitle, array('align' => 'left')));
...
jimport('joomla.filesystem.folder');
		...
		if(file_exists(JPATH_BASE. "/media/com_toes/DOCX".DS.$show_id.DS.'master_exibitor_woa_list.docx'))
			unlink (JPATH_BASE. "/media/com_toes/DOCX".DS.$show_id.DS.'master_exibitor_woa_list.docx');
