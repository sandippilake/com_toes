...
$pdf->SetTitle(JText::_('COM_TOES_MASTER_EXHIBITOR_WOA_LIST'));

// set default header data
$header_logo = '/media/com_toes/images/paw32X32.png';
$pdf->SetHeaderData($header_logo, 10, JText::_('COM_TOES_MASTER_EXHIBITOR_WOA_LIST'), JText::_('COM_TOES_WEBSITE'));
...
// set font
// setfontissue $pdf->SetFont('ptsans', '', 11);
...
if(file_exists(TOES_PDF_PATH.DS.$show_id.DS.'master_exibitor_woa_list.pdf'))
	unlink (TOES_PDF_PATH.DS.$show_id.DS.'master_exibitor_woa_list.pdf');

//Close and output PDF document
$pdf->Output(TOES_PDF_PATH.DS.$show_id.DS.'master_exibitor_woa_list.pdf', 'F');
*/
$pdf->Output( $show_id .'_master_exibitor_woa_list.pdf', 'I');
//============================================================+
// END OF FILE                                                
//============================================================+
