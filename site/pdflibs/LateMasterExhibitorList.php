...
$pdf->SetTitle(JText::_('COM_TOES_LATE_MASTER_EXHIBITOR_LIST'));

// set default header data
$header_logo = '/media/com_toes/images/paw32X32.png';
$pdf->SetHeaderData($header_logo, 10, JText::_('COM_TOES_LATE_MASTER_EXHIBITOR_LIST'), JText::_('COM_TOES_WEBSITE'));
...
if(file_exists(TOES_PDF_PATH.DS.$show_id.DS.'late_master_exibitor_list.pdf'))
	unlink (TOES_PDF_PATH.DS.$show_id.DS.'late_master_exibitor_list.pdf');

//Close and output PDF document
$pdf->Output(TOES_PDF_PATH.DS.$show_id.DS.'late_master_exibitor_list.pdf', 'F');
