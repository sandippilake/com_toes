...
if($entry1->entry_result_id_final != '')
{
			...
			//echo '<pre>'; print_r($show_class); echo '</pre>';die;
			...
			//	$final_best_array[$entry1->entry_competitive_class_id][$entry1->entry_ring_id][$entry1->entry_result_id_final] = $entry1->entry_catalog_number;
				...
				//echo '<pre>'; print_r($final_best_newarray); echo '</pre>';
			}
}
		...
		while (count($congress_rings) > $current_index) {
			...
			for ($j = 1; $j <= 10; $j++) {
				...
				for ($k = $current_index; $k < $i; $k++) {
					...
					if($final_best_newarray[$class][$ring->ring_id][$k] != '')
								{
									$final_best_array1 = $final_best_newarray[$class][$ring->ring_id][$k];
									$class_final_block .= $final_best_array1;
								}
								else{
									$class_final_block .= '__________';
