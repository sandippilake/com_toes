...
$pdf->SetCreator("TICA");
$pdf->SetTitle(JText::_('COM_TOES_EXHIBITOR_LIST'));

// set default header data
$header_logo = '/media/com_toes/images/paw32X32.png';
$pdf->SetHeaderData($header_logo, 10, JText::_('COM_TOES_EXHIBITOR_LIST'), JText::_('COM_TOES_WEBSITE'));
...
$pdf->MultiCell(100, 0, JText::_('COM_TOES_TOTAL_NUMBER_OF_EXHIBITORS'), 0, 'L', 1, 0);
...
if(file_exists(TOES_PDF_PATH.DS.$show_id.DS.'exibitor_list.pdf'))
	@unlink (TOES_PDF_PATH.DS.$show_id.DS.'exibitor_list.pdf');
*/
//Close and output PDF document
//$pdf->Output(TOES_PDF_PATH.DS.$show_id.DS.'exibitor_list.pdf', 'F');
header("Content-type: application/pdf");
$pdf->Output( $show_id .'_exibitor_list.pdf', 'I');
