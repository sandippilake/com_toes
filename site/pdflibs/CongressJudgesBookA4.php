...
$pdf->SetCreator("TICA");
$pdf->SetTitle(JText::_('COM_TOES_CONGRESS_JUDGES_BOOK_IN_A4'));
...
foreach($final_entries as $ring_number=>$ring_entries)
{
    ...
    if($cover_copy)
    {
        ...
        $front_page .= '<div style="text-align:center;">'.JText::_('COM_TOES_JUDGES_BOOK_AB').'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.JText::_('COM_TOES_JUDGES_BOOK_LH').'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.JText::_('COM_TOES_JUDGES_BOOK_SH').'</div><br/><br/>';
